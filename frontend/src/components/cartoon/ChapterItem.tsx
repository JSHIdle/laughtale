...
export default function ChapterItem(props: Props) {
    ...
    return (
        <Link to={`/cartoon/${props.mangaId}/viewer/${props.chapterId}`}>
            <div
                className="border border-[#73ABE5] hover:text-white hover:bg-gradient-to-r from-[#6CB3E4] to-[#8F89EB]  text-black font-semibold text-xl flex p-5 items-center rounded-2xl mb-5">
