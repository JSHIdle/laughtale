    ...
    return (
        <div className="flex gap-4">
            ...
            <div className="w-1/3 bg-gray-800 p-6 rounded-lg  mt-4 flex flex-col ">
                ...
                <label className="w-full h-60 bg-gray-500 bg-no-repeat bg-center bg-cover rounded border-2 border-blue-400 flex items-center justify-center cursor-pointer">
                    {thumbnailPreview ? (
                        <img src={thumbnailPreview} alt="Thumbnail preview" className="rounded" />
                    ) : (
                        <>
