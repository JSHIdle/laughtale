  ...
  return <div className="bg-[#212529]">
    <div className="max-w-[700px] m-auto">
      ...
      <div className="flex space-x-5">
        <div className="bg-gradient-to-r from-[#4EDBDE] from-5% to-[#5572A1] to-100% text-white font-semibold rounded-xl overflow-hidden mb-1 w-60 h-60 mr-4 flex justify-center items-center">
        <div>
